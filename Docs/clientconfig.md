...
## Windows
Na configuração do Windows foi mais simples. Instalei o agente NXLog e configurei-o para enviar logs para o servidor Rsyslog usando o módulo im_msvistalog que coleta logs do EventViewer através de queries. Aí, depois de coletadas, o módulo de extensão xm_syslog permite converter o formato em mensagens syslog, assim mandando no formato correto para o servidor.
